...
![Dashboard Page 1](/Power-BI-Month_2/Power_BI_Dashboards/Images/Project2_Page1.PNG)
...
-  **Dashboard Design:**
Crafting an intuitive and viasually appealing report layout.
-  **Power Query ETL:**
Performing data cleaning, shaping and transformation.
-  **Data Modeling:**
Building efficient data models with relationships (Star Schema Principles).
-  **DAX Fundamentals:**
Creating calculations and aggregations to derive key insights.
...
-  **Interactive Features:**
   * **Slicers:** Enabling dynamaic, user-driven data filtering.
