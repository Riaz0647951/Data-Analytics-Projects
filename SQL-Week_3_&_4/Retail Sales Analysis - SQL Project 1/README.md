...
2. **Set Up the Database**: Run the SQL scripts provided in the `Retail Sales Analysis - SQL Project 1.sql` file. After creating the database and its table, import data from the `SQL - Retail Sales Analysis_utf.csv ` file to populate the database.
3. **Run the Queries**: Use the SQL queries provided in the `Retail Sales Analysis - SQL Project 1.sql` file step by step to perform your analysis.
